...
<div class=message>
	<ul>
		<li>A new version[<%=siteConfig.getAppVersion() %>] available.recommend <a href="http://jdkcn.com/page/download.html">update.</a>,Important for myblog1.8</li>
		<li>新版本[<%=siteConfig.getAppVersion() %>] 发布了。请您 <a href="http://jdkcn.com/page/download.html">更新</a> 到最新版本。<strong>myblog1.8版本的请务必升级!</strong></li>
	</ul>
</div>
<%}%>